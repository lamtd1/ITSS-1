  ...
  const renderWordResult = (data) => (
    <div className="space-y-8 animate-fadeIn">
      ...
      {data.components && data.components.length > 0 && (
        <div>
          <h4 className="text-sm font-bold text-gray-500 mb-3 uppercase tracking-wide">構成</h4>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="text-center pt-8 pb-4">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">日本語 - ベトナム語辞書</h2>
        <p className="text-gray-500">日本語の用語や語彙をすぐに調べる</p>
      </div>
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          <div className="relative flex-1 flex items-center px-4 border-2 border-transparent focus-within:border-blue-500 rounded-xl bg-gray-50 transition-all duration-300">
            ...
            <input
              ...
              placeholder="日本語またはベトナム語で入力してください"
              value={term}
      ...
      {result ? (
        ...
        /* History / Suggestions */
        <div className="mt-8">
          <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4 px-2">語彙を調べたところ</h3>
          <div className="flex flex-wrap gap-3">
            ...
            {history.length === 0 && (
              <p className="text-gray-400 italic px-2">履歴はありません。</p>
            )}
          </div>
        </div>
      )}
