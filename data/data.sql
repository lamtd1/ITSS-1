...
INSERT INTO "Flashcard" (set_id, flashcard_front, flashcard_back, flashcard_is_learned) VALUES

-- === SET 1: Từ vựng CNTT (Của GV 1) - 3/5 đã học ===
(1, 'Pasokon (パソコン)', 'Máy tính cá nhân', TRUE),
(1, 'Mausu (マウス)', 'Chuột máy tính', TRUE),
(1, 'Kiiboodo (キーボード)', 'Bàn phím', FALSE),
(1, 'Gamen (画面)', 'Màn hình', TRUE),
(1, 'Intaanetto (インターネット)', 'Mạng Internet', FALSE),

-- === SET 2: Từ vựng Trường học (Của GV 2) - 1/5 đã học ===
(2, 'Sensei (先生)', 'Giáo viên', TRUE),
(2, 'Kyoushitsu (教室)', 'Lớp học', FALSE),
(2, 'Kokuban (黒板)', 'Bảng đen', FALSE),
(2, 'Jugyou (授業)', 'Giờ học', FALSE),
(2, 'Shukudai (宿題)', 'Bài tập về nhà', FALSE),

-- === SET 3: Chào hỏi cơ bản (HS A) - 5/5 đã học (Hoàn thành 100%) ===
(3, 'Konnichiwa (こんにちは)', 'Xin chào (ban ngày)', TRUE),
(3, 'Ohayou (おはよう)', 'Chào buổi sáng', TRUE),
(3, 'Konbanwa (こんばんは)', 'Chào buổi tối', TRUE),
(3, 'Arigatou (ありがとう)', 'Cảm ơn', TRUE),
(3, 'Sayounara (さようなら)', 'Tạm biệt', TRUE),

-- === SET 4: Đồ dùng học tập (HS B) - 2/5 đã học ===
(4, 'Hon (本)', 'Sách', TRUE),
(4, 'Enpitsu (鉛筆)', 'Bút chì', FALSE),
(4, 'Kaban (鞄)', 'Cặp sách', TRUE),
(4, 'Nooto (ノート)', 'Vở ghi chép', FALSE),
(4, 'Keshigomu (消しゴム)', 'Cục tẩy', FALSE),

-- === SET 5: Gia đình (HS C) - 0/5 đã học (Mới tạo) ===
(5, 'Kazoku (家族)', 'Gia đình', FALSE),
(5, 'Chichi (父)', 'Bố (của mình)', FALSE),
(5, 'Haha (母)', 'Mẹ (của mình)', FALSE),
(5, 'Ani (兄)', 'Anh trai', FALSE),
(5, 'Ane (姉)', 'Chị gái', FALSE),

-- === SET 6: Động vật (HS D) - 4/5 đã học ===
(6, 'Inu (犬)', 'Con chó', TRUE),
(6, 'Neko (猫)', 'Con mèo', TRUE),
(6, 'Tori (鳥)', 'Con chim', TRUE),
(6, 'Sakana (魚)', 'Con cá', FALSE),
(6, 'Uma (馬)', 'Con ngựa', TRUE),

-- === SET 7: Màu sắc (HS E) - 2/5 đã học ===
(7, 'Aka (赤)', 'Màu đỏ', TRUE),
(7, 'Ao (青)', 'Màu xanh dương', FALSE),
(7, 'Shiro (白)', 'Màu trắng', FALSE),
(7, 'Kuro (黒)', 'Màu đen', TRUE),
(7, 'Kiiro (黄色)', 'Màu vàng', FALSE),
...
(9, 'Tabemasu (食べます)', 'Ăn', TRUE),
(9, 'Nomimasu (飲みます)', 'Uống', FALSE),
(9, 'Ikimasu (行きます)', 'Đi', FALSE),
(9, 'Kimasu (来ます)', 'Đến', FALSE),
(9, 'Kaerimasu (帰ります)', 'Trở về', FALSE),

-- === SET 10: Động từ 2 (HS H) - 3/5 đã học ===
(10, 'Mimasu (見ます)', 'Xem, nhìn', TRUE),
(10, 'Kikimasu (聞きます)', 'Nghe', FALSE),
(10, 'Yomimasu (読みます)', 'Đọc', TRUE),
(10, 'Kakimasu (書きます)', 'Viết', TRUE),
(10, 'Hanashimasu (話します)', 'Nói chuyện', FALSE),

-- === SET 11: Thời gian (HS I) - 2/5 đã học ===
(11, 'Ima (今)', 'Bây giờ', TRUE),
(11, 'Mainichi (毎日)', 'Mỗi ngày', FALSE),
(11, 'Asa (朝)', 'Buổi sáng', TRUE),
(11, 'Hiru (昼)', 'Buổi trưa', FALSE),
(11, 'Yoru (夜)', 'Buổi tối', FALSE),

-- === SET 12: Phương tiện (HS K) - 4/5 đã học ===
(12, 'Kuruma (車)', 'Ô tô', TRUE),
(12, 'Jitensha (自転車)', 'Xe đạp', TRUE),
(12, 'Densha (電車)', 'Tàu điện', FALSE),
(12, 'Basu (バス)', 'Xe buýt', TRUE),
(12, 'Hikouki (飛行機)', 'Máy bay', TRUE);
...
(1, 3, 'Hello world', 'en', 'vi',
 '{"furigana": "こんにちは、せかい", "translation": "こんにちは、世界"}',
 'sentence', '2025-12-02 09:52:18.811'),

(2, 3, 'Chào bạn, bạn thích thịt gà không', 'auto', 'auto',
 '{"furigana": "こんにちは、とりにくは おすきですか？", "translation": "こんにちは、鶏肉はお好きですか？"}',
 'sentence', '2025-12-02 10:00:24.334'),

(3, 3, 'Thịt gà', 'auto', 'auto',
...
(5, 3, '鳥が大好き', 'auto', 'auto',
 ...
 'word', '2025-12-02 10:00:53.835'),

(6, 3, 'xin chào chú gà trống choai', 'auto', 'auto',
 '{"furigana": "こんにちは、わかいおんどりさん。", "translation": "こんにちは、若い雄鶏さん。"}',
 'sentence', '2025-12-02 10:03:05.064'),

(7, 3, 'gà trống\n', 'auto', 'auto',
 '{"furigana": "おんどり", "translation": "雄鶏 (おんどり)"}',
 'sentence', '2025-12-02 10:03:15.953'),

(8, 3, 'thịt chó mắm tôm', 'auto', 'auto',
 '{"furigana": "いぬにくのえびみそぞえ", "translation": "犬肉のえび味噌添え"}',
 'sentence', '2025-12-02 10:03:26.445'),

(9, 3, 'thịt chó', 'auto', 'auto',
 '{"furigana": "いぬのにく", "translation": "犬の肉"}',
 'sentence', '2025-12-02 10:03:32.893'),

(10, 3, 'thịt gà chấm muối, lá chanh', 'auto', 'auto',
 '{"furigana": "とりにくのしおれもんぞえ", "translation": "鶏肉の塩レモン添え"}',
 'sentence', '2025-12-03 03:11:29.782');